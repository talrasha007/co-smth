...
module.exports = class {
    ...
    *loadMember(user, from, size) {
        return yield *this._post('member/load_member_boards.json', {
            from: from,
            size: size,
            set_board: 1,
            user_id: user
    ...
    *joinMember(board) {
        return yield *this._post('member/join.json', { board_id: board });
    }

    *quitMember(board) {
        return yield *this._post('member/quit.json', { board_id: board });
    }
